...
namespace ShopLand.Infrastructure.Persistance.Migrations
{
    ...
    [Migration("20240307145825_RequestPayMig")]
    partial class RequestPayMig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShopLand.Domain.Account.Roles.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0b463ed1-b124-4dcf-b455-e4773889dcf8"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("ccbde7e0-703e-44f0-a1f3-5fc6c8ff6051"),
                            Name = "Customer"
                        });
                });
